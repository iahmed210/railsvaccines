...
class VaccinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vaccine" do
    assert_difference('Vaccine.count') do
      post vaccines_url, params: { vaccine: { antigen: @vaccine.antigen, code: @vaccine.code, name: @vaccine.name } }
    end
  ...
  test "should update vaccine" do
    patch vaccine_url(@vaccine), params: { vaccine: { antigen: @vaccine.antigen, code: @vaccine.code, name: @vaccine.name } }
